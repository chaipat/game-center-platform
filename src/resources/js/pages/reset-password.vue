    ...
    <v-row align="center" justify="center">
      <v-col cols="12" sm="8" md="6" lg="4">
        <v-card class="elevation-12">
          <v-toolbar class="text-center dark--text gold-gradient" >
          ...
          <v-card-text>
            ...
            <v-form v-if="emailAuth" v-model="formIsValid" @submit.prevent="login">
              <div class="text-subtitle-1 text-medium-emphasis yellow--text">Phone number</div>
              <v-row >
                <v-col cols="3" sm="2" md="2" lg="2" class="pe-1">
                  <!-- <v-text-field
                v-model="form.email"
                :label="$t('Email')"
                type="email"
              ...
              />
                ...
                <v-col cols="9" sm="10" md="10" lg="10" class="ps-1">
                  <v-text-field
                  color="yellow"
                v-model="form.email"
                :label="$t('')"
              ...
              <div class="text-subtitle-1 text-medium-emphasis yellow--text">Password</div>
              <v-text-field
                color="yellow"
              ...
              <v-row align="center">
                <v-col class="text-center text-md-left">
                  <v-btn type="submit" color="primary" class="gold-gradient text-black" :loading="loading">
