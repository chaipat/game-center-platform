                        ...
                        <v-expansion-panels>
                          ...
                          <v-expansion-panel>
                            ...
                            <v-expansion-panel-content>
                              ...
                              <v-switch
                                v-model="form.CONTENT_HOME_GAMES_FILTER"
                                :label="$t('Enable filter by game categories')"
                                color="primary"
                                false-value="false"
                                true-value="true"
                                class="mb-5"
                              ...
                              <v-text-field
                                v-if="form.CONTENT_HOME_GAMES_FILTER === 'false'"
                ...
                <v-card-text>
                  <v-expansion-panels>
                    ...
                    <v-expansion-panel>
                      ...
                      <v-expansion-panel-content>
                        <v-switch
                          v-model="form.EMAIL_AUTH"
                          :label="$t('Authentication with email')"
                          color="primary"
                          false-value="false"
                          true-value="true"
                        />
  ...
  data () {
    ...
    return {
      ...
      form: new Form({
        ...
        CONTENT_HOME_GAMES_FILTER: '' + config('settings.content.home.games.filter'),
        ...
        EMAIL_AUTH: '' + config('settings.users.email_auth'),
        ...
        APP_FULL_LOGO: config('app.full_logo'),
