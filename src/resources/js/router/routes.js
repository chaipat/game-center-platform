...
export default [
  ...
  // privacy Policy
  { path: '/policy', name: 'policy', component: page('policy'), meta: { layout: 'auth' } },
  { path: '/terms', name: 'terms', component: page('terms'), meta: { layout: 'auth' } },

  // profile
  { path: '/profile', name: 'profile', component: page('profile/index'), meta: { layout: 'auth' } },
  { path: '/profile/edit', name: 'edit-profile', component: page('profile/edit') },
  { path: '/profile/test', name: 'edit-profiletest', component: page('profile/edittest') },


  // transection
  { path: '/transection', name: 'transection', component: page('transection'), meta: { layout: 'auth' } },

  // topup
  { path: '/topup', name: 'topup', component: page('topup'), meta: { layout: 'auth' } },

  // blog
  { path: '/blog', name: 'blog', component: page('blog'), meta: { layout: 'default' } },
  // { path: '/blog-detail', name: 'blog-detail', component: page('blog-detail'), meta: { layout: 'default' } },
  { path: '/blog/:id', name: 'blog-view', component: page('blog/view'), meta: { layout: 'default' } },
  { path: '/blog/:id/:title', name: 'blog-view-title', component: page('blog/view'), meta: { layout: 'default' } },
  { path: '/category/:id', name: 'category-list', component: page('category'), meta: { layout: 'default' } },
  { path: '/category/:id/:title', name: 'category-list-title', component: page('category'), meta: { layout: 'default' } },
  ...
  { path: '/password/reset/email', name: 'password.email', component: page('password/email'), meta: { layout: 'auth' } },
  { path: '/password/reset', name: 'password.reset', component: page('password/reset'), meta: { layout: 'auth' } },
  { path: '/password/change', name: 'password.change', component: page('password/change'), meta: { layout: 'auth' } },
  { path: '/password/change/:token', name: 'password.change', component: page('password/change'), meta: { layout: 'auth' } },
  ...
  // games
  { path: '/games/', name: 'game', component: page('games') },
...

  {
    ...
    children: [
      { path: 'password', name: 'user.security.password', component: page('password/change') },
