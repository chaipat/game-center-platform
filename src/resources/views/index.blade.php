...
<head>
  ...
  <link rel="shortcut icon" href="{{ asset('images/favicon/Logo.svg') }}">
  ...
  <meta property="og:image" content="{{ file_exists(public_path('images/logo/og-image-udf.jpg')) ? asset('images/logo/og-image-udf.jpg') : asset('images/logo/og-image.jpg') }}" />
  <!--END Open Graph tags-->
