...
return [
    ...
    'theme' => [
        ...
        'colors' => [
            ...
            'dark'        => env('THEME_COLOR_DARK', '#272727'),
        ],
        'backgrounds' => [
            // 'app_bar'       => env('THEME_BACKGROUND_APP_BAR', '#272727'),
            'app_bar'       => env('THEME_BACKGROUND_APP_BAR', '#232323'),
            'system_bar'    => env('THEME_BACKGROUND_SYSTEM_BAR', '#000000'),
            // 'page'          => env('THEME_BACKGROUND_PAGE', '#121212'),
            'page'          => env('THEME_BACKGROUND_PAGE', '#000000'),
            'nav_bar'       => env('THEME_BACKGROUND_NAV_BAR', '#18181C'),
        ...
        'fonts' => [
            'body' => [
                ...
                'url' => env('THEME_FONT_BODY_URL', 'https://fonts.googleapis.com/css2?family=Khula:wght@300;700&family=Inter:wght@400;700&family=Orbitron:wght@700&display=swap'),
                'family' => env('THEME_FONT_BODY_FAMILY', 'Khula'),
            ],
            'heading' => [
                'url' => env('THEME_FONT_HEADING_URL', ''),
                'family' => env('THEME_FONT_HEADING_FAMILY', 'Orbitron'),
            ],
        ],
    ],
