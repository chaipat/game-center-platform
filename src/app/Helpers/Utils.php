...
class Utils
{
    ...
    public static function supervisorServiceIsRunning(): bool
    {
        ...
        $output = Process::run('service supervisor status; service supervisord status');

        return $output->seeInOutput('artisan queue:work') || $output->seeInOutput('supervisord is running');
    }
}
